...
//		pop_carriageSelect.add(
	...
	tf_createCarriage_passengers.setHorizontalAlignment(JTextField.RIGHT);
	...
	testPanel.setBounds(0, 0, (int)(2.0f/3.0f * width), (int)(2.0f/3.0f * height));
	
	JTextArea t = new JTextArea(100, 100);
	t.setBounds(10, 10, 800, 150);
